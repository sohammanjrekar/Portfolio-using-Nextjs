    ...
    <div>
      ...
      <div className=" flex items-center">
        ...
        <ul className="sm:flex space-x-4 hidden items-center">
          <li><Link href="/" className="text-white hover:text-indigo-600 text-md ">Home</Link></li>
          <li><Link href="/about" className="text-white hover:text-indigo-600 text-md ">About</Link></li>
          <li><Link href="/movie" className="text-white hover:text-indigo-600 text-md ">movie</Link></li>
          <li><Link href="/contact" className="text-white hover:text-indigo-600 text-md ">Contact</Link></li>
        </ul>
