...
const Hero1 = () => {
  return (
    <>
       <div class="bg-white relative pb-20 lg:pt-44 dark:bg-gray-900">
            ...
            <div class="lg:flex">
                ...
                <div class="mt-12 md:mt-0 lg:absolute -right-10 lg:w-7/12">
                    <div class="relative w-full">
                        ...
                        <img src="https://tailus.io/sources/blocks/tech-startup/preview/images/globalization-cuate.svg" class="relative w-full" alt="wath illustration" loading="lazy" width="620" height="110"/>
                    </div>
                </div>
            </div>
        </div>
